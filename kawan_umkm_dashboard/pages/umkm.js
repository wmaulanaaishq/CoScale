  ...
  return (
    <div>
      ...
      <section className="mt-6 rounded-xl border bg-white p-5">
        ...
        <p className="mt-1 text-sm text-gray-500">Isi nama usaha dan lokasi kota. Untuk MVP, kirim data via perintah dfx dari WSL.</p>
        ...
        <div className="mt-3 flex items-center justify-between">
          <button onClick={warnManual} className="rounded bg-blue-600 px-4 py-2 text-white">Daftarkan (MVP: via dfx call)</button>
          <p className="text-xs text-gray-500">Contoh: dfx canister call kawan_umkm_backend registerUmkm '("Warung Ibu Siti","Bandung")'</p>
        </div>
      </section>

      <section className="mt-6 rounded-xl border bg-white p-5">
        <h2 className="text-lg font-semibold">Input Kebutuhan</h2>
        <p className="mt-1 text-sm text-gray-500">Masukkan barang, kuantitas, unit, dan lokasi. Untuk MVP: submit via dfx call atau biarkan agen agregator mengisi otomatis.</p>
        <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <div className="mt-3 flex items-center justify-between">
          <button onClick={warnManual} className="rounded bg-green-600 px-4 py-2 text-white">Kirim (MVP: via agen/dfx)</button>
          <p className="text-xs text-gray-500">Contoh: dfx canister call kawan_umkm_backend buatKebutuhan '(1,"Beras",10,"kg","Bandung")'</p>
        </div>
      </section>
